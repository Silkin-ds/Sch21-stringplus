...
START_TEST(strcat_1) {
  char b1[1024] = "";
  char b11[1024] = "";
  char str_1_2[1024] = "HELLO WORLD TEST!";

  ck_assert_pstr_eq(strcat(b1, str_1_2),
                    s21_strncat(b11, str_1_2, s21_strlen(str_1_2)));
}
END_TEST
...
START_TEST(strcat_2) {
  ...
  ck_assert_pstr_eq(strcat(b2, str_2_2),
                    s21_strncat(b22, str_2_2, s21_strlen(str_2_2)));
}
END_TEST
...
START_TEST(strcat_3) {
  char b3[1024] = "111";
  char b33[1024] = "111";
  char str_3_2[1024] = " HELLO!";

  ck_assert_pstr_eq(strcat(b3, str_3_2),
                    s21_strncat(b33, str_3_2, s21_strlen(str_3_2)));
}
END_TEST
...
START_TEST(strcmp_1) {
  char *str_1_1 = "HELLO!";
  char *str_1_2 = "HELLO!";
  int s21_c = s21_strncmp(str_1_1, str_1_2, strlen(str_1_1));
  int s_c = strncmp(str_1_1, str_1_2, strlen(str_1_1));
  if (s21_c > 0)
    s21_c = 1;
  else if (s21_c < 0)
    s21_c = -1;
...
START_TEST(strcmp_2) {
  char *str_2_1 = "HELLO WORLD TEST!";
  char *str_2_2 = "HELLO OF WORLD TEST!";
  int s21_c = s21_strncmp(str_2_1, str_2_2, strlen(str_2_1));
  int s_c = strncmp(str_2_1, str_2_2, strlen(str_2_1));
  if (s21_c > 0)
    s21_c = 1;
  else if (s21_c < 0)
    s21_c = -1;
...
START_TEST(strcmp_3) {
  char *str_3_1 = "HELLO OF WORLD TEST!!!!!";
  char *str_3_2 = "HELLO!";
  int s21_c = s21_strncmp(str_3_1, str_3_2, strlen(str_3_1));
  int s_c = strncmp(str_3_1, str_3_2, strlen(str_3_1));
  if (s21_c > 0)
    s21_c = 1;
  else if (s21_c < 0)
    s21_c = -1;
...
START_TEST(strncmp_2) {
  s21_size_t n = 3;
  char *str_2_1 = "HELLO WORLD TEST!";
  char *str_2_2 = "LU GANO OF WORLD TEST!!";
...
START_TEST(memcmp_2) {
  s21_size_t n2 = 3;
  void *str_2_1 = "HELLO WORLD TEST!";
  void *str_2_2 = "LU GANO OF WORLD TEST!!";
...
START_TEST(memcmp_3) {
  s21_size_t n3 = 3;
  void *str_3_1 = " HELLO OF WORLD TEST!!";
  void *str_3_2 = "HELLO!";
...
START_TEST(memset_1) {
  s21_size_t n1 = 6;
  int c1 = '7';
  char b1[1024] = "HELLO WORLD TEST!";
  char b11[1024] = "HELLO WORLD TEST!";
...
START_TEST(memcpy_2) {
  ...
  char b2[1024] = "";
  char b22[1024] = "";
  char str_2_2[1024] = "WORLD OF \0TEST!!";
...
START_TEST(memcpy_4) {
  s21_size_t n4 = 4;
  char b4[1024] = "HELLO! 111 ";
  char b44[1024] = "HELLO! 111 ";
...
START_TEST(memmove_2) {
  s21_size_t n2 = 4;
  char b2[1024] = "111 3333333";
  char b22[1024] = "111 3333333";
...
START_TEST(memmove_3) {
  s21_size_t n3 = 4;
  char b3[1024] = "111 HELLO!";
  char b33[1024] = "111 HELLO!";
...
START_TEST(memmove_4) {
  s21_size_t n4 = 4;
  char b4[1024] = "111 HELLO!";
  char b44[1024] = "111 HELLO!";
...
START_TEST(strerror_1) {
  for (int i = -1; i < MAXN; i++) {
    ...
    const char *actual = s21_strerror(i);
...
START_TEST(strstr_not_word_in_haystack) {
  char haystack[] = "WORLDre is no right word in this test!";
  char needle[] = "NOT";
  ck_assert_pstr_eq(s21_strstr(haystack, needle), strstr(haystack, needle));
}
END_TEST
...
START_TEST(sprintf_flags_anoWORLDr_long_int) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
...
START_TEST(sprintf_test_sprintf9) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, format, 666666666666, 111, 111),
                   sprintf(str2, format, 666666666666, 111, 111));
...
START_TEST(sprintf_test_sprintf10) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, format, 666, -111, 111),
                   sprintf(str2, format, 666, -111, 111));
...
Suite *suite_insert(void) {
  ...
  tcase_add_test(tc, sprintf_flags_anoWORLDr_long_int);
